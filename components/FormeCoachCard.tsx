...
const REST_DAY_TIPS = [
  ...
  "Foam rolling for 5-10 minutes on rest days can reduce soreness and improve range of motion for your next session.",
  "Deload weeks aren't a sign of weakness. Reducing intensity every 4-6 weeks helps prevent burnout and overtraining.",
  "Walking 8,000-10,000 steps on rest days improves recovery, heart health, and helps manage body composition without taxing your muscles.",
  "Cold showers for 2-3 minutes can reduce inflammation and speed up recovery between sessions.",
  "Stress raises cortisol, which breaks down muscle and stores fat. Use rest days to decompress and recharge mentally.",
  "Your nervous system needs recovery too. If you feel mentally drained, rest days are when your body repairs and adapts.",
  "Active recovery like a light walk or gentle stretching on rest days helps blood flow without adding training stress.",
  "Sleep quality matters as much as duration. Keep your room cool, dark, and screen-free for the last 30 minutes before bed.",
  "Rest days are when your muscles actually grow. The micro-tears from training repair stronger \u2014 but only if you let them.",
  "Light mobility work on rest days keeps your joints healthy and can actually make you feel less stiff than doing nothing.",
  "Hydration doesn't stop on rest days. Your muscles need water to repair \u2014 aim for at least 2-3 liters today.",
  "Use rest days to meal prep. Good nutrition on off days is just as important as what you eat around workouts.",
  "A 10-minute meditation or breathing session on rest days lowers cortisol and primes your nervous system for your next workout.",
];
...
export function getTodayTip(isRestDay?: boolean): string {
